...
class InventoryAllocatorTest(unittest.TestCase):
    ...
    def testEmptyWarehouseOneOrder(self):
        ...
        cheapestShipment = []
        inventoryAllocator = InventoryAllocator()
        leftovers, cheapestShipment = inventoryAllocator.emptyWarehouse(orders, warehouses, furthest, cheapestShipment)
    ...
    def testGetCheapestShipmentsMultipleOrderOneShipment(self):
        orders = { "apple": 5 , "orange": 5, "banana": 5, "grape": 5}
        warehouses = [
        ...
        inventoryAllocator = InventoryAllocator()
        cheapestShipment = inventoryAllocator.getCheapestShipments(orders, warehouses)
        self.assertEqual(cheapestShipment, [{ "all": { "apple": 5,
                                                        "orange": 5,
                                                        "banana": 5,
                                                        "grape": 5 } }])
